...
def solve_result(demand_filepath, bb_filepath, radius, max_count, cost_field, budget, value_field, opened):
    ...
    #opt_billboards, total_covered_val = methods.mclp_greedy.greedy_mclp(I, J, s, max_count, cost, budget, v, opened)
    #opt_billboards, total_covered_val = methods.mclp_greedy_muticore.greedy_mclp(I, J, s, max_count, cost, budget, v, opened)
    opt_billboards, total_covered_val = methods.mclp_sa.solve_mclp(I, J, s, max_count, cost, budget, v, opened)
